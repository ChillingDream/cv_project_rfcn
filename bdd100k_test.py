...
bdd_dataset = BDD100K_dataset(bdd100k_path='/home/zkj/codes/cv_project_rfcn/data/bdd100k', dataset_list=['train'], dump_to='bdd100k_train.pkl')
bdd_dataset2 = BDD100K_dataset(bdd100k_path='/home/zkj/codes/cv_project_rfcn/data/bdd100k', dataset_list=['val'], dump_to='bdd100k_val.pkl')
print('bdd100k dump!')
